...
class FoodAdapter(private var source: String, private var info: String?)
    ...
    inner class FoodViewHolder(parent: ViewGroup) :
            RecyclerView.ViewHolder(parent.inflate(R.layout.food_item, false)) {
...
//                val p2 = Pair.create(risk_icon as View, context.getString(R.string.food_risk_transition_name))
                context.startActivity(intent) //, ActivityOptionsCompat.makeSceneTransitionAnimation(context as Activity, p2).toBundle())
            }
        }
    }
}
